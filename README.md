...
![Build Status](https://github.com/ahmedbasha22/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
...
This project implements a RESTful Account microservice for an e-commerce platform. The service is responsible for keeping track of customer accounts and exposes a well-formed REST API so that other microservices in the system can create, read, update, delete, and list customer records.
